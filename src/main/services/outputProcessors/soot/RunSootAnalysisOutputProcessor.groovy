...
class RunSootAnalysisOutputProcessor implements OutputProcessor {
    ...
    RunSootAnalysisOutputProcessor(String dependenciesPath) {
        ...
        this.detectionAlgorithms = [
                ...
                new ConflictDetectionAlgorithm("OA Intra Hybrid Pointer Analysis", "oa-hybrid-pa", this.sootWrapper, TIMEOUT),
                new ConflictDetectionAlgorithm("OA Inter Hybrid Pointer Analysis", "ioa-hybrid-pa", this.sootWrapper, TIMEOUT, true),
